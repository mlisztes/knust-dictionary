...
const RandomEntry = (props) => {   
    return(
        ...
        <div className="seven wide tablet four wide computer column">
            ...
            Search for a symbol, <br /><i className="ui ellipsis vertical icon"></i> browse the dictionary <br />or check out a random entry:
        ...
        <div className="seven wide tablet four wide computer column">            
            {/* <img className="ui medium image" alt="welcome" src='/img/welcome2b.png'></img>
            <br></br> */}
